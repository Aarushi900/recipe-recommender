...
def ingredient_parser1(ingreds):
...
if __name__ == "__main__":
    ...
    tfidf.fit(df_recipes1['ingredients_parsed'])
    tfidf_recipe = tfidf.transform(df_recipes1['ingredients_parsed'])
